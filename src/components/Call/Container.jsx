...
function Container({ data }) {
  ...
  return (
    <div
      className="w-full border-l border-conversation-border bg-conversation-panel-background flex flex-col 
    h-[100vh] overflow-hidden items-center justify-center text-white"
    >
